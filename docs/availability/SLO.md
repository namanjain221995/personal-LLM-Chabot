...
| 120-min soak on candidate B (`scripts/cluster-soak.py --minutes 120 --concurrency 10`, 10:50–12:51Z) | **PASS**: 8,851 / 8,851 requests ok (short 5,351 · medium 2,637 · long 863), 1,471,585 streamed chunks (~204/s), 0 faults, 0 restarts, Xid 2/2 unchanged on both nodes, controller READY throughout with no incident; TTFT p50 0.16 / 0.55 / 2.53 s (short / medium / long) — the same workload fired the GDN fault at 27 min on the pinned build on 2026-09-11 | `.runtime/logs/soak-B-20260912T1050Z.log`, `.runtime/logs/cluster-soak-20260912-162029.*` |
