...
_MIGRATION_V29 = """
-- V29 (2026-09-11): durable, generation-correlated query tracing.
--
...
_SIDE_TABLES = (
    # V29 query tracing. Bare /chat calls can have no conversations row, so
...
# ---------------------------------------------------------------------------
# Generation-correlated query tracing (V29)
# ---------------------------------------------------------------------------
