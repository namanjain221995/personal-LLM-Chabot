...
def test_the_public_api_body_caps_are_the_contracts_per_route_ones(probe_routes):
    ...
    the two generating routes (20 MiB, image parts), transcriptions (26 MiB)
    and, since the Files hookup, the file upload routes. A route nobody named
    — this file's probe — stays at 1 MiB."""
